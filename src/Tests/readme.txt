Firstly thanks a lot for using TestStack.BDDfy; but I can see that you are using the old package: 
...
changes to your code so it will compile again:
 ...
 - Replace All (ctrl+shift+h) instances of '.BDDfy(' with '.BDDfy('
 - Replace All instances of '.BDDfy<' with '.BDDfy<' if you are using the overload with TStory type argument.
 - Replace All instances of 'using TestStack.BDDfy' with 'using TestStack.BDDfy'
